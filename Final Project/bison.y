...
%token SCAN LESS GREAT WHILE INT DOUBLE FACT CHAR MAIN PB PE BB BE DOT CM ASGN PRINTVAR PRINTSTR PRINTLN PLUS MINUS MULT DIV LT GT LE GE IF ELSE ELSEIF FOR INC DEC TO SWITCH DEFAULT COL FUNCTION
%nonassoc IFX
%nonassoc ELSE
%left SH
